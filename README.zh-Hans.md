...
Pet 可绑定与游戏共用的经济实例和账户，购买使用服务端永久收据并支持本地恢复发货。旧存档先备份，再经受控的一次性迁移导入；本地余额不是可信云资产。当前 profile 汇总不能排除游戏推理，因此暂停该来源奖励且不积累待补收入。见[共享经济与迁移](docs/shared-economy.md)及[宠物系统说明](docs/pet-system.md)。
